...
class GymApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.title('Fitness Revolution Gym Management')
        self.configure(bg='Black')
        self.geometry('850x625')
        l1 = tk.Label(self, text = 'Welcome to Fitness Revolution Gym Centers', font=("Arial", 28, "bold"), bg='Red3',fg='white').pack()
        container = tk.Frame(self, bg='Red3')
...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.configure(bg='black')
        label = tk.Label(self, text = 'ADMIN LOGIN ONLY', font=("Helvetica", 30), bg='white').pack(pady=10, padx=10)
        username = tk.Label(self, text = 'Enter Username', font=("Times", 24)).pack(pady=20)
        self.ev1 = tk.StringVar()
        e1 = tk.Entry(self, width = 50, textvariable = self.ev1, font=("Times", 20)).pack()
        password = tk.Label(self, text = 'Enter Password', font=("Times", 24)).pack(pady=20)
    ...
    def authenticate(self):
        ...
        for row in r:
            if self.ev1.get() == row[0] and self.ev2.get() == row[1]:
                ...
                messagebox.showinfo('Login Successful!', 'Welcome to Fitness Revolution Gym Management System!!')
                flag = 1
                conn.commit()
                cur.close()
...
class Menu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'Start Menu', font=("Arial", 30), bg='black',fg='white').pack(pady=24, padx=10)
...
class AddCustomer(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'Add Customer', font=("Helvetica", 30, "italic"), bg='Black').pack(pady=10, padx=10)
        label = tk.Label(self, text = 'Enter Customer ID', font=("Helvetica", 22),bg='Black',fg='white').pack()
        self.custID = tk.StringVar()
        customerID = tk.Entry(self, width = 50, textvariable = self.custID, font=("Times", 20)).pack(pady=10)
        label = tk.Label(self, text = 'Enter Customer Name', font=("Helvetica", 22),bg='Black',fg='White').pack()
        self.nameVar = tk.StringVar()
        name = tk.Entry(self, width = 50, textvariable = self.nameVar, font=("Times", 20)).pack(pady=10)
        label = tk.Label(self, text = 'Enter Phone Number', font=("Helvetica", 22),bg='Black',fg='White').pack()
        self.phone = tk.StringVar()
        phoneNo = tk.Entry(self, width = 50, textvariable = self.phone, font=("Times", 20)).pack(pady=10)
        label = tk.Label(self, text = 'Enter Joining Date', font=("Helvetica", 22),bg='Black',fg='White').pack()
        self.date = tk.StringVar()
        joiningDate = tk.Entry(self, width = 50, textvariable = self.date, font=("Times", 20)).pack(pady=10)
        ...
        success = tk.Label(self, text = '', font=("Helvetica", 10, "italic"), bg='Black', textvariable = self.text).pack(pady=6, padx=10)
...
class AddPackage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'Add Package', font=("Helvetica", 30, "italic"), bg='Black').pack(pady=10, padx=10)
        label = tk.Label(self, text = 'Enter Package ID', font=("Helvetica", 22),bg='Black',fg='white').pack()
        self.packID = tk.StringVar()
        packageID = tk.Entry(self, width = 50, textvariable = self.packID, font=("Times", 20)).pack(pady=12)
        label = tk.Label(self, text = 'Enter Package Type', font=("Helvetica", 22),bg='Black',fg='white').pack()
        self.typeVar = tk.StringVar()
        type = tk.Entry(self, width = 50, textvariable = self.typeVar, font=("Times", 20)).pack(pady=12)
        label = tk.Label(self, text = 'Enter Package Facilities', font=("Helvetica", 22),bg='Black',fg='white').pack()
        self.facil = tk.StringVar()
        facilities = tk.Entry(self, width = 50, textvariable = self.facil, font=("Times", 20)).pack(pady=12)
        label = tk.Label(self, text = 'Enter Cost of Package', font=("Helvetica", 22),bg='Black',fg='white').pack()
...
class ShowCustomers(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'List of Customers', font=("Helvetica", 30, "italic"), bg='Black').pack(padx=10)
...
class ShowPackages(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'List of Packages', font=("Helvetica", 30, "italic"), bg='Black').pack(padx=10)
...
class SearchCustomer(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='Black')
        label = tk.Label(self, text = 'Search Customer by Name', font=("Helvetica", 30, "italic"), bg='Black').pack(padx=10)
        label = tk.Label(self, text = 'Enter Customer Name', font=("Helvetica", 22),bg='Black',fg='white').pack()
...
class AddSubscription(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = 'Add Subscription', font=("Helvetica", 30, "italic"), bg='Black').pack(padx=10, pady=15)
        label = tk.Label(self, text = 'Enter Subscription ID', font=("Helvetica", 22),bg='Black',fg='white').pack(pady=10)
        self.subsID = tk.StringVar()
        subscriptionID = tk.Entry(self, width = 50, textvariable = self.subsID, font=("Times", 20)).pack()
        label = tk.Label(self, text = 'Enter Customer Name', font=("Helvetica", 22),bg='Black',fg='white').pack(pady=10)
        self.custName = tk.StringVar()
        customerName = tk.Entry(self, width = 50, textvariable = self.custName, font=("Times", 20)).pack()
        label = tk.Label(self, text = 'Enter Package ID', font=("Helvetica", 22),bg='Black',fg='white').pack(pady=10)
        self.packID = tk.StringVar()
        packageID = tk.Entry(self, width = 50, textvariable = self.packID, font=("Times", 20)).pack()
        label = tk.Label(self, text = 'Select No. of Months', font=("Helvetica", 22),bg='Black',fg='white').pack(pady=10)
...
class AddPayment(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='black')
        label = tk.Label(self, text = 'Add Payment', font=("Helvetica", 30, "italic"), bg='Black').pack(padx=10, pady=15)
        label = tk.Label(self, text = 'Enter Receipt No.', font=("Helvetica", 22),bg='Black',fg='white').pack()
        ...
        invoiceBill = tk.Label(self, text = '', font=("Helvetica", 20, "italic"), bg='cyan', textvariable = self.invoice).pack(pady=12, padx=10)
